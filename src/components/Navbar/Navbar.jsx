                ...
                <div className='container py-3 sm:py-0'>
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex items-center gap-4'>
                            ...
                            <button onClick={onOpenMenu} className='bg-gradient-to-r from-primary to-secondary text-white px-4 py-1 rounded-full hover:scale-105 hover:shadow-2xl duration-300 flex items-center gap-3'>
                                Order
